...
typedef enum {
    ...
    DONE,            ///< message with string (doesn't include trailing '\0') 2
    ACK,             ///< empty message 3 
    STOP,            ///< empty message 4
    TRANSFER,        ///< message with TransferOrder 5 
    BALANCE_HISTORY, ///< message with BalanceHistory 6
    CS_REQUEST,      ///< empty message 7 
    CS_REPLY,        ///< empty message 8 
    CS_RELEASE       ///< empty message 9
} MessageType;
