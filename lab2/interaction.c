    ...
    while (true) {
        ...
        if (tMsg->s_header.s_type == TRANSFER) {
            ...
            if (tBody->s_dst == proc) {
                ...
                fprintf(events, log_transfer_in_fmt, tMsg->s_header.s_local_time, proc,  tBody->s_amount, tBody->s_src);
                fflush(events);
                ...
                fprintf(events, log_transfer_out_fmt, newTime, proc, tBody->s_amount, tBody->s_dst);
                fflush(events);
